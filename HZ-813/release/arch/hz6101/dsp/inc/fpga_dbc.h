...
//TXModules FR CONFIG
#define DBC_TXMODULE_FR_CTRLREG     	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x0000*2)
#define DBC_TXMODULE_FR_BLOCK_WORD_NUM  (volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x0001*2)
#define DBC_TXMODULE_FR_TOTAL_WORD_NUM  (volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x0002*2)
#define DBC_TXMODULE_FR_STATUSREG    	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x0004*2)
#define DBC_TXMODULE_FR_DMA_RCV_CNT  	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x0008*2)
#define DBC_TXMODULE_FR_TX_OK_CNT    	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x0009*2)
#define DBC_TXMODULE_FR_CRC_ERR_CNT  	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x000A*2)
#define DBC_TXMODULE_FR_STR_ERR_CNT  	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x000B*2)
#define DBC_TXMODULE_FR_CACHE_FULL_CNT 	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x000C*2)
#define DBC_TXMODULE_FR_TX_ERR_CNT    	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x000D*2)
#define DBC_TXMODULE_FR_TIC_ERR_CNT   	(volatile Uint16 *)(FPGA_DBC_TO_FR_CFG_ADDR+0x000E*2)


//TXModules FR DATA
#define DBC_TX_FR_CACHE             (volatile Uint16 *)(FPGA_DBC_TO_FR_ADDR+((0x0000)<<1))
...
//控保发送主从互校mask
#define TX_IEC_MASK_REG1             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0000)*2))
#define TX_IEC_MASK_REG2             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0001)*2))
#define TX_IEC_MASK_REG3             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0002)*2))
#define TX_IEC_MASK_REG4             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0003)*2))
#define TX_IEC_MASK_REG5             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0004)*2))
#define TX_IEC_MASK_REG6             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0005)*2))
#define TX_IEC_MASK_REG7             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0006)*2))
#define TX_IEC_MASK_REG8             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0007)*2))
#define TX_IEC_MASK_REG9             (volatile Uint16 *)(FPGA_DBC_TX_IEC_MASK_ADDR+((0x0008)*2))

//FEU发送主从互校mask寄存器
#define TX_SMC_MASK_REG1             (volatile Uint16 *)(FPGA_DBC_TX_SMC_MASK_ADDR+((0x0000)*2))//NCU
#define TX_SMC_MASK_REG2             (volatile Uint16 *)(FPGA_DBC_TX_SMC_MASK_ADDR+((0x0001)*2))//SCU
#define TX_SMC_MASK_REG3             (volatile Uint16 *)(FPGA_DBC_TX_SMC_MASK_ADDR+((0x0002)*2))//ICU
