...
//Slave only
#define FPGA_SHARE_RAM0_ADDR      (FPGA_EMIF_BASE_ADDR+(0x0400<<1) )      // FPGA起始地址
#define SIZE_OF_FPGA_RAM0         ((0x400)<<1)       

//Slave only
#define FPGA_SHARE_RAM1_ADDR      (FPGA_EMIF_BASE_ADDR+(0x0800<<1) )      // FPGA起始地址
#define SIZE_OF_FPGA_RAM1          ((0x800)<<1)                 // 寄存器范围
...
//Master & Slave
#define FPGA_IEC_TXMOD_ADDR       (FPGA_EMIF_BASE_ADDR+(0x41000<<1))       // FPGA起始地址, 当前未使用
#define SIZE_OF_FPGA_IEC          ((0x1000)<<1)
