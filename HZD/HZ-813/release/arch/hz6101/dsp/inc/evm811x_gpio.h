...
#define GPIO0_BASE          0x08032000
#define GPIO0_SYSCONFIG     *( volatile Uint32* )( GPIO0_BASE + 0x10 )
#define GPIO0_OE            *( volatile Uint32* )( GPIO0_BASE + 0x0134 ) // 0 = o/p, 1 = i/p
#define GPIO0_DATAIN        *( volatile Uint32* )( GPIO0_BASE + 0x0138 )
#define GPIO0_DATAOUT       *( volatile Uint32* )( GPIO0_BASE + 0x013C )
#define GPIO0_CLEARDATAOUT  *( volatile Uint32* )( GPIO0_BASE + 0x190 )
#define GPIO0_SETDATAOUT    *( volatile Uint32* )( GPIO0_BASE + 0x194 )
#define GPIO0_CTRL          *( volatile Uint32* )( GPIO0_BASE + 0x130 )
