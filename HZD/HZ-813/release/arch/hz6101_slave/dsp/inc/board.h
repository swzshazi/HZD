...
extern char   bs_flag;
extern int    self_pid;
extern Uint8  bus_bjj_in; 
extern Uint8  bus_qd_in; 
extern Uint8  bus_bsj_in;
extern Uint8  fpga_crc_err; 
extern char   bus_bsj_level;
extern Uint8  register_type_mask;
...
extern void   delayNs(Uint32 count);
extern void   delayUs(Uint32 count);
extern void   monitorCpuLoad(void);
extern void   configMmb(Uint8 mmb_no, Uint8  total_no,Uint16 start_word_no,Uint16 length,  Uint8 send_no);
extern void   enableMmb(Uint8 send_no0, Uint8 send_no1);
extern void   sendAllCANMsg(void);
extern void   canWrite(Uint8 addr,Uint8 data);
extern void  *nvram_malloc(size_t size);                             
extern void  *nvram_calloc(size_t nmemb, size_t size);               

extern Uint32 mem1_free_addr;                                       
extern Uint32 mem2_free_addr;                                       
extern Uint32 mem3_free_addr;                                       

extern Uint32 mem1_free_size;                                       
extern Uint32 mem2_free_size;                                       
extern Uint32 mem3_free_size;                                       

extern Uint32 mem1_used_size;                                       
extern Uint32 mem2_used_size;                                      
extern Uint32 mem3_used_size;                                     

extern Uint32 mmb1_frame_num;
extern Uint32 mmb2_frame_num;

extern Uint8 signal_address;                                       

extern void *dsp_calloc(size_t nmemb, size_t size, char mem_type); 
extern Uint32 readNowTime(void);
extern Uint32 readFpgaTime(void);
...
extern int moveDMAData(Uint32 src_addr, Uint32 dest_addr, Uint32 data_len, Uint8 dma_channel);
extern int isMemDMABusy(Uint8 dma_channel);
extern int sendPcieData(Uint32 pcie_addr, Uint8 *send_data_p, Uint32 data_len, Uint8 dma_channel);
extern int isPcieSendBusy(Uint8 dma_channel);
extern int recvPcieData(Uint32 pcie_addr, Uint8 *recv_data_p, Uint32 data_len);
...
extern int isPcieRecvBusy(void);
